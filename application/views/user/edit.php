            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'barista' ? 'checked' : ''; ?> <?= set_radio('role', 'barista'); ?> value="barista" type="radio" id="barista" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="barista">Barista</label>
                        </div>
